...
def extract(path):
    ...
    # db = DBImport(db_file=os.path.join(os.path.abspath(".."), "output", "database14092022.db"))
    db = DBImport(db_file=os.path.join("C:\/Users\/phucp\/Desktop", "output", "database14092022.db"))
